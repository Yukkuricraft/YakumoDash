...
import {
  getBackupChoice,
  getBackupsList,
  isBackupsListReadyToRender,
  getContainerDef,
  getInProgressRollbacks,
  isBackupChoiceSelected,
  getSnapshotWorldsList,
  isSnapshotWorldsListReadyToRender,
} from "@app/store/backups/backups.selectors";
...
export class BackupsFacade {
  ...
  public onBackupChoiceConfirmed(
    containerDef: ContainerDefinition,
    backupChoice: BackupDefinition,
    worlds: string[],
    ...
    this.store.dispatch(
      backupChoiceConfirmed({
        ...
        backupChoice,
        worlds,
        bypassRunningContainerRestriction,
      })
    );
  }
...
export const backupsFeatureFacades = [BackupsFacade];
