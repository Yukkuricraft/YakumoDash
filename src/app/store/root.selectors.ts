...
import { ActiveContainer, ContainerDefinition, ContainerType } from "@app/models/container";
...
export const selectActiveContainerByContainerDef = (containerDef: ContainerDefinition) => {
  ...
  return createSelector(selectActiveContainerByEnvTypeAndName({ name: envString } as Env, type, name), (container) => container)
}
